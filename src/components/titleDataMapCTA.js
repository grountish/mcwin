      ...
      <div className="flex flex-col lg:flex-row pt-20 pb-32 justify-between">
        <div className="lg:w-1/2 w-full lg:pr-10 pb-10 lg:pb-0">
          ...
          <div className="pb-10">
            ...
            >
              <img src={urlFor(dataOneIcon)} alt="logo" className="w-[20px]" />
            ...
            <a
              ...
              className="flex space-x-2 py-2 anim cursor-pointer"
            >
              <img src={urlFor(dataTwoIcon)} alt="logo" className="w-[20px]" />
            ...
            >
              <img
                ...
                className="w-[20px]"
              />
              <BlockContent blocks={dataThree} className="text-xs lg:text-lg" />
            </a>
          </div>
